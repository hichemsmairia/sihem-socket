...
class SymptomJournal extends Component {
  ...
  handleFormSubmit = event => {
    ...
    if (this.state.symptomType === "") {
      this.setState({
        symptomTypeError: "Choisir le symptome de la list"
      })
    }
    ...
    if (this.state.symptomDay === "" || this.state.symptomDay === "mm/dd/yyy") {
      this.setState({
        symptomDayError: "Date de symptome"
      })
    }
    ...
    if (this.state.symptomTime === "") {
      this.setState({
        symptomTimeError: "Temp d'apparition du symptome."
      })
    }
    ...
    if (this.state.symptomInfo === "") {
      this.setState({
        symptomInfoError: "a propos le symptome , s'il n'ya aucune remarque taper N/A"
      })
    }
