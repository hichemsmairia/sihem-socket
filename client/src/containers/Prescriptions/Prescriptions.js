...
class Prescriptions extends Component {
 ...
 loadPatients = () => {
    ...
    handlePrescriptionPatientChange = (event) => {
        this.setState({ 
          prescriptionPatient: event.target.value,
          formSuccessMessage: "",
        });
    }
    ...
    handleFormSubmit = event => {
        ...
        if (this.state.prescriptionDirections === "") {
          ...
          PrescriptionsAPI.savePrescription({
              ...
              patientprescribed: this.state.prescriptionPatient,
                ...
                <Grid container spacing={16}>
                  <Grid item xs={12} sm={12} md={6}>
                    <PrescriptionsForm
                      ...
                      handlePrescriptionPatientChange={this.state.handlePrescriptionPatientChange}
                    ...
                    {this.state.prescriptions.map(prescription => {
                      return (
                        <PrescriptionsList
                          ...
                          prescriptionPatient={prescription.patientprescribed}
